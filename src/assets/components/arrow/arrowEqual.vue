<!-- arrow equal from bootstrap : https://icons.getbootstrap.com/icons/arrow-down-short/ -->
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrows" viewBox="0 0 16 16">
